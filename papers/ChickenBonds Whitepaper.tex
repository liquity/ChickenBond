...
\begin{equation}
  \label{eq:naive-2}
   PV(PermanentBucket) = \frac{q_d}{q_a} \frac{r_d}{r_a} d_f PV(ReserveBucket)
\end{equation}

Recalling that $PV(ReserveBucket) = q_a$, we can derive that

\begin{equation}
  \label{eq:naive-3}
   PV(PermanentBucket) = q_d \frac{r_d}{r_a} d_f
\end{equation}
...
\begin{equation}
  \label{}
  \frac{S}{\Delta t} = \frac{s(T_{opt})}{\Delta t} = \frac{q_p}{T_{opt}} \frac{1}{p_r} \frac{T_{opt}}{T_{opt}+\alpha} = \frac{S}{q_a} \frac{q_p}{T_{opt}+\alpha}
\end{equation}
...
\begin{equation}
  \label{}
  \frac{S}{\Delta t} = q_p \frac{S}{q_a} \frac{1}{T_t+\alpha}
  =  \frac{S}{q_a} \frac{q_p}{T_t+ T_t\frac{\frac{p_f}{p_r} - 1}{1 + \sqrt{\frac{p_f}{p_r}}}}  
  =  \frac{S}{q_a} \frac{q_p}{T_t+ T_t\frac{\lambda - 1}{1 + \sqrt{\lambda}}}  
\end{equation}
...
where $q_{b}$ stands for the amount bonded at the end of recursion step. As $p_r = \frac{q_a}{S_{sLQTY}}$, we can express the above equation as:
