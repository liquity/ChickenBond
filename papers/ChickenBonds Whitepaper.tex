...
=======
\date{May 24, 2021}
>>>>>>> 7f347e49321ccf98d1f12593aa36f017eab387fc
...
Note that the curves are getting for higher $\alpha$ and that all the equations have lower branches, only one of which is shown on the chart (in blue for $\alpha$=50). 
...
Note that the impact $q_p$ on the fair price gets bigger for larger $T_t$, and the same is true for $q_d$ and $q_a$, which influence $p_f$ in the same fashion.
=======
