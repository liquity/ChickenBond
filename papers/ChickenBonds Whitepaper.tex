...
\[
f_T'(n) = b \left(\frac{p_f}{p_r} \frac{T}{T+n}\right)^n \left(\ln\left(\frac{p_f}{p_r} \frac{T}{T+n}\right) - n \frac{\frac{p_f}{p_r} \frac{T}{(T+n)^2}}{\frac{p_f}{p_r} \frac{T}{T+n}}\right) = b \left(\frac{p_f}{p_r} \frac{T}{T+n}\right)^n \left(\ln\left(\frac{p_f}{p_r} \frac{T}{T+n}\right) - \frac{n}{T+n}\right)
\]
...
\[
\frac{p_f}{e p_r} \frac{T}{T+n} = e^{\frac{n}{T+n} - 1}
\]

\[
\frac{p_f}{e p_r} \frac{T}{T+n} = e^{\frac{-T}{T+n}}
\]

\[
\frac{T}{T+n} e^{\frac{T}{T+n}} = \frac{p_f}{e p_r} 
\]

And then, it has the form $z e^z = w$ from Lambert W function: \url{https://en.wikipedia.org/wiki/Lambert_W_function}, so:

\[
\frac{T}{T+n} = W\left(\frac{p_f}{e p_r} \right)
\]

\[
1 + \frac{n}{T} = \frac{1}{W\left(\frac{p_f}{e p_r} \right)}
\]

\[
n = \frac{T}{W\left(\frac{p_f}{e p_r} \right)} - 1
\]
...
\begin{equation}
  \label{}
T_{opt} = \frac{T}{n} = \frac{W\left(\frac{e p_r}{p_f}\right)}{1 - W\left(\frac{e p_r}{p_f}\right)}
\end{equation}
...
At time $t$, when the user chickens in and rebonds, the new bond amount $b'$ will be:
\begin{equation}
b'= p_f\frac{b(1-\tau)}{p_r}\frac{t}{t+1}
\end{equation}

From that point until the end there will be a period of $T-t$, where the outcome of the bond will be:
\begin{equation}
f_r = p_f\frac{b'(1-\tau)}{p_r}\frac{T-t}{T-t+1}
\end{equation}

So finally we have
\begin{equation}
  \label{eq:o-r}
f_r = b\left(\frac{(1-\tau)p_f}{p_r}\right)^2\frac{t}{t+1}\frac{T-t}{T-t+1}
\end{equation}
...
\begin{equation}
  \label{eq:n-rebond_1}
f_n(t) = b \left(\frac{(1-\tau)p_f}{p_r}\right)^n \left(\frac{T}{T+n}\right)^{n-1} \frac{t - \frac{n}{n-1}T}{t - \frac{n}{n-1}T + 1}
\end{equation}
...
\begin{equation}
  \label{eq:n-rebond_2}
f_n(T) = b \left(\frac{(1-\tau)p_f}{p_r}\right)^{n} \left(\frac{T}{T+n}\right)^{n-1} \frac{\frac{T}{n}}{\frac{T}{n} + 1}
\end{equation}

\begin{equation}
  \label{eq:n-rebond_3}
f_n(T) = b \left(\frac{(1-\tau)p_f}{p_r} \frac{T}{T+n} \right)^{n}
\end{equation}
...
\[
\begin{split}
  f_T'(n) &= b \left(\frac{(1-\tau)p_f}{p_r} \frac{T}{T+n}\right)^n \left(\ln\left(\frac{(1-\tau)p_f}{p_r} \frac{T}{T+n}\right) - n \frac{\frac{(1-\tau)p_f}{p_r} \frac{T}{(T+n)^2}}{\frac{(1-\tau)p_f}{p_r} \frac{T}{T+n}}\right) \\
  &= b \left(\frac{(1-\tau)p_f}{p_r} \frac{T}{T+n}\right)^n \left(\ln\left(\frac{(1-\tau)p_f}{p_r} \frac{T}{T+n}\right) - \frac{n}{T+n}\right)
\end{split}
\]
...
\[
f_T'(n) = 0 \iff \ln\left(\frac{(1-\tau)p_f}{p_r} \frac{T}{T+n}\right) = \frac{n}{T+n}
\]

\[
\frac{(1-\tau)p_f}{p_r} \frac{T}{T+n} = e^{\frac{n}{T+n}}
\]

Dividing by $e$ both sides:

\[
\frac{(1-\tau)p_f}{e p_r} \frac{T}{T+n} = e^{\frac{n}{T+n} - 1}
\]

\[
\frac{(1-\tau)p_f}{e p_r} \frac{T}{T+n} = e^{\frac{-T}{T+n}}
\]

\[
\frac{T}{T+n} e^{\frac{T}{T+n}} = \frac{(1-\tau)p_f}{e p_r} 
\]

And then, it has the form $z e^z = w$ from Lambert W function: \url{https://en.wikipedia.org/wiki/Lambert_W_function}, so:

\[
\frac{T}{T+n} = W\left(\frac{(1-\tau)p_f}{e p_r} \right)
\]

\[
1 + \frac{n}{T} = \frac{1}{W\left(\frac{(1-\tau)p_f}{e p_r} \right)}
\]

\[
n = \frac{T}{W\left(\frac{(1-\tau)p_f}{e p_r} \right)} - 1
\]
...
\begin{equation}
  \label{}
T_{opt} = \frac{T}{n} = \frac{W\left(\frac{e p_r}{(1-\tau)p_f}\right)}{1 - W\left(\frac{e p_r}{(1-\tau)p_f}\right)}
\end{equation}
...
\begin{equation}
  \label{eq:opt-rebonding}
T_{opt} = \frac{W\left(\frac{e}{(1-\tau)\lambda}\right)}{1 - W\left(\frac{e}{(1-\tau)\lambda}\right)} = \frac{1}{\frac{1}{W\left(\frac{e}{(1-\tau)\lambda}\right)} - 1}
\end{equation}
