...
contract ChickenBondManagerDevOnlyTest is BaseTest, DevTestSetup {
    ...
    function testFirstChickenInAfterRedemptionDepletionAndCurveHarvestTransfersToRewardsContract() external {
        ...
        assertApproximatelyEqual(
            ...
            initialPermanentLUSDInSP + _getTaxedAmount(bondAmount2) - accruedBLUSD,
            1,
        ...
        assertApproximatelyEqual(
            ...
            curveYield + _getTaxForAmount(bondAmount1) + _getTaxForAmount(bondAmount2) + bLUSDBalance * backingRatio / 1e18 * (1e18 - redemptionFeePercentage) / 1e18,
            250,
