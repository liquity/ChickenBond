# @@RickGriff NOTE: Deployed Yearn LUSD Vault code recorded here for convenience. Not used in development or deployment.
# === Only governance ===
# setName
# setSymbol
# setGovernance
...
# setPerformanceFee
# setManagementFee
# setEmergencyShutdown:  only governance can set active. Governance or guardian can make inactive.
# addStrategy
# updateStrategyPerformanceFee
# migrateStrategy: points vault to new strategy, and tells strategy to transfer all LUSD it holds to the new strategy
# sweep sends all of a given token held by this vault to governance address. LUSD prohibited
#
#
# === Only guardian or governance ===
# setGuardian
# setEmergencyShutdown (deactivate)
#
#
# === Only management or governance ===
# setWithdrawalQueue - orders strategies according to their withdrawal precedence when user withdraws from the vault
# updateStrategyDebtRatio - sets fraction of assets of this vault that the strategy can manage
# updateStrategyMinDebtPerHarvest -  Change the quantity assets per block this Vault may deposit to or withdraw from `strategy`.
# updateStrategyMaxDebtPerHarvest
# addStrategyToQueue
# removeStrategyFromQueue
#
#
# === Only management, governance or strategy contract ===
# revokeStrategy - sets strategy's debt limit to 0 and prevents deposits
#
